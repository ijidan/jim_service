...
type Message struct {
	...
	ReceiverID   uint64         `gorm:"column:receiver_id;not null;default:0" json:"receiver_id"`     // 接收人ID，单聊则为user_id,群聊则为group_id
	ReceiverType int32          `gorm:"column:receiver_type;not null;default:0" json:"receiver_type"` // 接收人类型
	AtUserID     string         `gorm:"column:at_user_id;not null" json:"at_user_id"`                 // 需要@的用户，多个用,分割
	MessageType  int32          `gorm:"column:message_type;not null;default:0" json:"message_type"`   // 消息类型
	Data         string         `gorm:"column:data;not null" json:"data"`                             // 内容
