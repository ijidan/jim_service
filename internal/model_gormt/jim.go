...
type GroupUser struct {
	...
	UserShowname string    `gorm:"column:user_showname;type:varchar(20);not null" json:"userShowname"`                                           // 用户在群组的昵称
...
type Message struct {
	...
	SenderID     int       `gorm:"column:sender_id;type:int;not null;default:0" json:"senderId"`              // 发送人ID
	SenderType   int8      `gorm:"column:sender_type;type:tinyint;not null;default:0" json:"senderType"`      // 发送人类型
	ReceiverID   int       `gorm:"column:receiver_id;type:int;not null;default:0" json:"receiverId"`          // 接收人ID，单聊则为user_id,群聊则为group_id
	ReceiverType int8      `gorm:"column:receiver_type;type:tinyint;not null;default:0" json:"receiverType"`  // 接收人类型
	ToUserIDs    string    `gorm:"column:to_user_ids;type:varchar(255);not null;default:''" json:"toUserIds"` // 需要@的用户，多个用,分割
